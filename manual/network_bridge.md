## Install packages
```bash
sudo apt install ros-${ROS_DISTRO}-network-bridge
```
...
/**/*:
  ros__parameters:
    ...
    UdpInterface:
      local_address: "127.0.0.1" #e.g. 10.8.0.2
      receive_port: 5001
      remote_address: "127.0.0.1" #e.g. 10.8.0.1
      send_port: 5000
    ...
    subscribe_namespace: "/udp2"
    publish_namespace: "/udp2"
```

2. Run
```bash
ros2 launch lucia_controller udp.launch.py
```